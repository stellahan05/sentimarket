...
def test_collect_all_data():
    ...
    with patch('src.data_collection.DataCollector.get_stock_data') as mock_stock:
        with patch('src.data_collection.DataCollector.get_reddit_posts') as mock_reddit:
            # Mock stock data
            ...
            # Mock Reddit posts
            mock_reddit.return_value = ["Post 1", "Post 2", "Post 3"]
...
def test_error_handling():
    ...
    # Test with invalid stock symbol (using a very long invalid symbol)
